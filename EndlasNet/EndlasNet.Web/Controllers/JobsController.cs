...
namespace EndlasNet.Web.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobId,EndlasNumber,JobDescription,Status,PurchaseOrderNum,DueDate,UserId,CustomerId")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("JobId,EndlasNumber,JobDescription,Status,PurchaseOrderNum,DueDate,UserId,CustomerId")] Job job)
        {
            if (id != job.JobId)
            {
                return NotFound();
