...
namespace EndlasNet.Web.Controllers
{
    public class StaticPowderInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaticPowderInfoId,PowderName,Density,FlowRateSlope,FlowRateYIntercept")] StaticPowderInfo staticPowderInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("StaticPowderInfoId,PowderName,Density,FlowRateSlope,FlowRateYIntercept")] StaticPowderInfo staticPowderInfo)
        {
