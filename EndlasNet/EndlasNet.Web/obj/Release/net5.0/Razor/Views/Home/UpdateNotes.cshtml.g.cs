#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "115332fc275755b6d4c51316b6d8abd160e26039"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"115332fc275755b6d4c51316b6d8abd160e26039", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "115332fc275755b6d4c51316b6d8abd160e260394177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        ...
        <li class=""update-notes-li"">
            Started the workflow for putting powder to batches of parts. Can select work. Then a screen is rendered with checkboxes for
            each part in the selected job. There is also a weight form. On submit, the workflow stops working correctly.
        </li>
        <li class=""update-notes-li"">
        ...
        <li class=""update-notes-li"">
            Now composition pdf persists when editing a static powder info row. The pdf can be ch");
            WriteLiteral(@"anged, or a checkbock can be selected
        ...
        <li class=""update-notes-li"">
            ...
            display for details and delete. Shows each row comment on index. Works as intended.
        </li>
        <li class=""update-notes-li"">
        ...
        <li class=""update-notes-li"">
            Fixe");
            WriteLiteral(@"d issue where password wasn't being set properly on user edit. Now password can be successfully changed.
        </li>
        <li class=""update-notes-li"">
            Fixed issue where powder order number wasn't displaying in details of line item. Added number of bottles to detials and
            the uninitialize view.
        </li>
        <li class=""update-notes-li"">
        ...
        <li class=""update-notes-li"">
            ...
            Refactored Machini");
            WriteLiteral(@"ngToolForWorkController to use the repository rather than the context.
        </li>
        <li class=""update-notes-li"">
