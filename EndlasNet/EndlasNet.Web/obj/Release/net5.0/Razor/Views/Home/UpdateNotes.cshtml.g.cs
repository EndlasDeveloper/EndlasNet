#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bda2b043ddd2611fd3f6c7caae1e04e77daebd84"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bda2b043ddd2611fd3f6c7caae1e04e77daebd84", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "bda2b043ddd2611fd3f6c7caae1e04e77daebd844177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            StaticPowderInfo -> changed powder name to endlas description. Changed in places I could see needed changing on the front-end.
        </li>
        <li class=""update-notes-li"">
            Redesigned using a machining tool for work to use the work - work item - part for work schema (from work - part for work).
            <ul>
                <li>
                    Updated ERD to reflect db schema changes made to allow user to save a log of machining tools being used for work.
                </li>
                <li>
                    User can use a machining tool for a job/work order by first selecting a work, then the user selects a work item from
                    the work's item list. After the user selects the work item, selection for which machining tool to use, date used,
                    comment, etc.
           ");
            WriteLiteral(@"     </li>
                <li>
                    When machining tools have been used, they successfully display on the index view (parent information as well).
                </li>
                <li>
                    User can edit an existing machining tool for work log by clicking edit from index. User can change any number
                    of attributes associated with the action of using a machining tool for work, and all attributes save and persist
                    as they should.
                </li>
                <li>
                    Details and delete view shows all parent table information.
                </li>
                <li>
                    User can successfully delete unwanted machining tool for work logs.
                </li>
            </ul>
        </li>
    </ul>
...
");
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            Put back buttons in Job-WorkItem-PartForWork
        </li>
        <li class=""update-notes-li"">
            Error check on all in powder order.
        </li>
        <li class=""update-notes-li"">
            All powders bug
        </li>
        <li class=""update-notes-li"">
            Action -> Set part weight
        </li>
        <li class=""update-notes-li"">
            LineItem -> change vendor description to endlas description
        </li>
        
        <li class=""update-notes-li"">
            Powder for parts -> add in index, both work and work item like in create.
        </li>
        <li class=""update-notes-li"">
            Condition description for parts -> want it to apply to lilst of parts
        </li>
        <li class=""update-notes-li"">
     ...
     ");
        ...
        <li class=""update-notes-li"">
            Keep writing Moq tests now that the controllers that ");
            WriteLiteral(@"are important accept an interface repo as a parameter.
        </li>
        <li class=""update-notes-li"">
