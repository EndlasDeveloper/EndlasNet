#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c407b702cbb5df3d938795e4bfa0a0e7916fcdfe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c407b702cbb5df3d938795e4bfa0a0e7916fcdfe", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c407b702cbb5df3d938795e4bfa0a0e7916fcdfe4177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            StaticPowderInfo -> Details, Delete -> changed UI to show Information pdf rather than whatever is there now.
        </li>
        <li class=""update-notes-li"">
            Process sheet notes were showing on edit. It now references information pdf where composition pdf used to be.
        </li>
        <li class=""update-notes-li"">
            Job -> Added short description to job quote dropdown display (in addition to EndlasNumber). Added JobViewModel class to handle the dropdown.
        </li>
        <li class=""update-notes-li"">
            Work -> added StartDate and PoDate as nullable attributes.
        </li>
        <li class=""update-notes-li"">
            Job -> added StartDate and PoDate in the UI for Create and Edit. In Details, if the date(s) isn't set, the UI indicates such.
        </li>
        <li class=""update-notes");
            WriteLiteral(@"-li"">
            WorkOrder -> added StartDate and PoDate in the UI for Create and Edit. In Details, if the date(s) isn't set, the UI indicates such.
        </li>
        <li class=""update-notes-li"">
            Job -> edit -> make quote reference persist. The current quote reference is what the dropdown is defaulted to.
        </li>
        <li class=""update-notes-li"">
            Added 4 more image attributes to PartForWork (optional).
            names: Machining, Cladding, Finished, Used. Implemented all back-end code needed for these attributes. Added all front-end code
            for PartsForJobs to handle setting, resetting, and unsetting the image files. Images display in both details and delete views.
            If an image isn't set, a stock image indicating there is not set image displays.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in PartForWork where PartForWorkImg wasn't set (because it doesn't have to be) and upon viewing the row details, an
   ");
            WriteLiteral(@"         exception would throw. Now the PartForJob CRUD work-flow seems to be working as intended.
        </li>
        <li class=""update-notes-li"">
            Fixed issue: Edit -> part for a job -> have current image then set to none gives error. (Kinda related to the above bulleted item).
        </li>
    </ul>
