#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "55c6988c69847c2d8b2831204a5179ad5674d525"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"55c6988c69847c2d8b2831204a5179ad5674d525", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "55c6988c69847c2d8b2831204a5179ad5674d5254177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            Fixed issue in Job where after endlas number duplicate submit, customers not in dropdown.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in WorkOrder where after endlas number duplicate submit, customers not in dropdown.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in PowderBottle edit where powder bottle number unique wasn't being enforced.
        </li>
        <li class=""update-notes-li"">
            Machining Tool, Add vendor id (str) column. Added form for extra attribute in create and edit. Added display for
            new attribute under details and delete. Didn't add that to the index view.
        </li>
        <li class=""update-notes-li"">
            Fixed UI issue under jobs and work orders. Customer select dropdown wasn't labeled properly in all UI elements invo");
            WriteLiteral(@"lving customer.
            Looks as it should.
        </li>
        <li class=""update-notes-li"">
            Under powder for parts, when creating a new object, only work items with parts will be displayed in the dropdown. Added ascending
            sort to the retrieved parts so they are ordered. Put check in to ensure the user chooses at least 1 part before submitting. If user
            doesn't choose at least 1, the user is forwarded back to the create page with a warning message under parts.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in PowderForParts, Suffix Asc - Desc wasn't working. Now working as intended.
        </li>
        <li class=""update-notes-li"">
            Static powder info -> added estimated cost per pound column on back-end. Added UI forms and display elements for estimated cost
            per pound.
        </li>
        <li class=""update-notes-li"">
            Machining Tools -> added column on index for cost per machining tool. Ad");
            WriteLiteral(@"ded cost per machining tool on details and delete views
            as well. Amount is formatted to display as a dollar amount.
        </li>
        <li class=""update-notes-li"">
            PowderForParts -> added Asc - Desc sort for powder bottle. Works as intended.
        </li>
        <li class=""update-notes-li"">
            All powders -> put sorts on lot number and bottle number (Asc-Desc). Both work as intended.
        </li>
        <li class=""update-notes-li"">
            Powder for parts -> put sort in for part drawing image. Groups like drawing image rows together. Works
            as intended.
        </li>
        <li class=""update-notes-li"">
            Replaced the 'Asc - Desc' sort action links with images of red up and down arrows. Looks much cleaner.
        </li>
    </ul>
...
");
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            Add quotes tab, quotes action link to CRUD operations for quote.
        </li>
        <li class=""update-notes-li"">
            Consider adding back tto tab from index(s).
        </li>
        <li class=""update-notes-li"">
        ...
        <li class=""update-notes-li"">
            Implement repository patte");
            WriteLiteral("rn for more entities and replace the direct context calls in the controllers.\r\n        </li>\r\n    </ul>\r\n\r\n");
