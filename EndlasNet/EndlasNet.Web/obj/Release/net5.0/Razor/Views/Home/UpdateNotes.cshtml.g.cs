#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d2a6d88d09de9299fc435925ae5c167397a4ca12"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d2a6d88d09de9299fc435925ae5c167397a4ca12", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d2a6d88d09de9299fc435925ae5c167397a4ca124177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        ...
        <li class=""update");
            ...
            Fixed issue in PowderForParts -> Details view still had an edit option that led to an old view I didn't realize was still there. Removed
            all unnecessary view files from views. Removed unnecessary controller methods that corresponded to the removed views.
        </li>
        <li class=""update-notes-li"">
            Fixed subtle issue with respect to database migrations. The database can have existing data, a database schema change can be made, then,
            after the changes have been applied, the data will persist.
        </li>
        <li class=""update-notes-li"">
            PartForWork -> filters rows by PO date (by year/month/day). Added search bar to search for parts for work by the work's due date. Added
            capability to search for a due date, then apply either suffix sore or filter by work type.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in Jobs -> Jobs was allowing the user to create multiple jobs referenci");
            WriteLiteral(@"ng a single quote. This shouldn't be. There was/is a check
            put into place in quotes to make sure the user cannot put in duplicate quotes with the same endlas number, however. Now only quotes without
            job references appear in the dropdown for quote reference when creating a job.
        </li>
        <li class=""update-notes-li"">
            Refactored Part for job/work order. Now it uses a view model rather than the data model. Also, the views group the rows into similar work
            parent classes.
        </li>
    </ul>
