#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "12d9f34b3b0717d8ca2066d176e2c57298247f4b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"12d9f34b3b0717d8ca2066d176e2c57298247f4b", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "12d9f34b3b0717d8ca2066d176e2c57298247f4b4177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        <li class=""update-notes-li"">
            PowderForPart -> Db zeros out the powder weight if below threshold.
        </li>
        <li class=""update-notes-li"">
            Powder/LineItem -> removed bottle cost (put cost storage in line item).
        </li>
        <li class=""update-notes-li"">
            LineItem -> added weight total cost and LineItemNumber (str).
        </li>
        <li class=""update-notes-li"">
            Powder -> Index, Display, and Delete UIs weight values now round to 4 decimal places.
        </li>
        <li class=""update-notes-li"">
            PowderOrder Create -> added number of line items, removed add line item. Overall, better work flow implemented.
            On powder order create, the number of line items is chosen. When manage line items is clicked, the number of line
            items exists on the view in an uninitialized state. ");
            WriteLiteral(@"An action button is on the row of the uninitialized line item
            to initialize the line item. In initialization, the number of powder bottles is selected. Upon initialize, the user
            is forwarded back to the line item list again, except the row that was just initialized shows a manage powders action
            link.
        </li>
        <li class=""update-notes-li"">
            Relabled PO order price to Batch PO cost (MachiningTools).
        </li>
        <li class=""update-notes-li"">
            Added action tab to nav-bar. Put physical action representations here (Powders for parts, Tools for work).
        </li>
    </ul>
