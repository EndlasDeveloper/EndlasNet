#pragma checksum "C:\Users\EndlasLaptop2\Desktop\EndlasNet\EndlasNet\EndlasNet.Web\Views\Home\UpdateNotes.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8ce5d52600dd7b84331bfd3a020d4ea5e9934526"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8ce5d52600dd7b84331bfd3a020d4ea5e9934526", @"/Views/Home/UpdateNotes.cshtml")]
    ...
    public class Views_Home_UpdateNotes : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "8ce5d52600dd7b84331bfd3a020d4ea5e99345264177", async() => {
            }
            );
...
#nullable disable
    ...
    <ul style=""font-size:14px;line-height:200%;"">
        ...
        <li class=""update-notes-li"">
            Redid front-end structure to represent Job -> WorkItem -> PartForWork from Job -> PartForWork. Next step is to implement same workflow for work orders.
        </li>
        <li class=""update-notes-li"">
            Fixed issue in Inventory -> All powders. Exception was being thrown because of changes in the work - work item - part for work structure.
            Now works as intended.
        </li>
        <li>
        ");
            WriteLiteral(@"    Fixed powder to parts functionality. Now, after parts exist in a job, the user can choose a work, then choose a work item, then the user can click
            get parts. Then the user is shown some forms for setting a date used, which powder bottle is to be used, how much powder to use, and wheich parts
            to apply the powder weight to. Seems to work as intended.
        </li>
        <li>
            Fixed issue in delete and details (under powder for part) where the static part info drawing wasn't rendering and static powder info wasn't being
            passed along to the view.
        </li>
        <li>
            Reworked PowderForPart views to work with the new work schema. The user can select create new powder for part. Upon doing so, the user is shown a
            view with a dropdown to select the work of interest. Once the work is selected, the user can click get work items. On clicking that, the user
            is forwarded to another page where another dropdown appears ");
            WriteLiteral(@"with the work items populated inside. After the user selects the work item, the user
            can click get parts. From there, the user is shown a series of forms to fill out about the metrics and powder applied to the part. The user can 
            select 1 or more parts to apply a powder weight to. (Bug- if no part is selected the screen goes bad).
        </li>
