            ...
            modelBuilder.Entity("EndlasNet.Data.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CustomerId = new Guid("d4a499a9-045c-442e-a91e-76871d1db9fe"),
            ...
            modelBuilder.Entity("EndlasNet.Data.PartForWorkImg", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PartForWorkImgId = new Guid("6d959002-e8af-4ea7-9aa8-16c59edc5180"),
                            ImageName = "None"
                        });
                });
            ...
            modelBuilder.Entity("EndlasNet.Data.Vendor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VendorId = new Guid("c73f3b1b-18aa-4f24-bf01-ab00e0998fd2"),
                            PointOfContact = "Dummy Point of Contact",
            ...
            modelBuilder.Entity("EndlasNet.Data.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("8f7460a9-3497-457a-8e7e-eb7062fb094f"),
                        ...
                        new
                        {
                            UserId = new Guid("e9fd8815-b0c8-4aaa-8976-ff15f53cceae"),
                        ...
                        new
                        {
                            UserId = new Guid("ffda5fba-dbdf-443d-bf57-1b1110708468"),
                        ...
                        new
                        {
                            UserId = new Guid("7470fc81-0f39-4614-b1fe-88d843a6a868"),
