            ...
            modelBuilder.Entity("EndlasNet.Data.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CustomerId = new Guid("a3c69d65-a8fa-455f-a598-0e67080a6480"),
            ...
            modelBuilder.Entity("EndlasNet.Data.Vendor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VendorId = new Guid("2bc0a218-c592-43b7-bf48-8d30740cd173"),
                            PointOfContact = "Dummy Point of Contact",
            ...
            modelBuilder.Entity("EndlasNet.Data.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3e2352c8-ce78-4978-ac32-da017e00643b"),
                        ...
                        new
                        {
                            UserId = new Guid("91eba8b5-f12d-4c0a-a9c4-e4cc2f41ef72"),
                        ...
                        new
                        {
                            UserId = new Guid("b704b079-a566-46d9-86ab-9e4ed6fe9828"),
                        ...
                        new
                        {
                            UserId = new Guid("991284a3-c15d-4d14-8d37-d4044802fd28"),
