namespace EndlasNet.Data
{
    ...
    */
    public static class ConnectionStrings
    {
        ...
        public const string endlas_db = "Server=192.168.1.103,1433\\SQLEXPRESS;Database=endlas_db;user id=SA; password=sa1qazxsw2!QAZXSW@;Trusted_Connection=True;Integrated security=False;";
